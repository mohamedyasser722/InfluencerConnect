        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandSocialMediaProfile", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BrandSocialMediaProfile_Brands_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                name: "InfluencerSocialMediaProfile",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InfluencerSocialMediaProfile", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InfluencerSocialMediaProfile_Influencers_InfluencerId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "InfluencerSocialMediaProfile",
                column: "InfluencerId");
        }
